...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
    ...
    const data = React.useMemo(
        () => ({
            ...
            navSecondary: [{ title: "Logout", url: "/logout", icon: IconLogout }],

            admin: [
                { name: "Dashboard", url: "/dashboard", icon: IconCategory },
                { name: "Kelola Bimbingan", url: "/dashboard/bimbingan", icon: IconBubbleText },
            ],

            admin_core: [
                { name: "Jurusan & Prodi", url: "/dashboard/jurusanprodi", icon: IconSchool },
                { name: "Dosen", url: "/dashboard/dosen", icon: IconUsers },
                { name: "Mahasiswa", url: "/dashboard/mahasiswa", icon: IconUsers },
                { name: "Relasi Bimbingan", url: "/dashboard/relasibimbingan", icon: IconExchange },
            ],

            admin_setting: [{ name: "Kustomisasi Carousel", url: "/dashboard/kustomisasi/carousel", icon: IconSlideshow }],

            mahasiswa: [
                { name: "Home", url: "/homepage", icon: IconHome },
                { name: "Konseling", url: "/konseling", icon: IconMessageCircleUser },
                { name: "Profil", url: "/profil", icon: IconUser },
            ],
